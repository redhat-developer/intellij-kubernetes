...
class EndpointsProvider(client: KubernetesClient)
    ...
    override fun getNamespacedOperation(namespace: String): Supplier<ResourceOperation<Endpoints>?> {
        return Supplier { client.endpoints().inNamespace(namespace) }
    }

    override fun getNonNamespacedOperation(): Supplier<ResourceOperation<Endpoints>?> {
        return Supplier { client.endpoints().inAnyNamespace() as ResourceOperation<Endpoints> }
    }
}
